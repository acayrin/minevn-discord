...
var filter = (function () {
    function filter(list) {
        ...
        this.__regex = new RegExp(/[a-zA-Z0-9]|[áÁảẢãÃạẠ]|[ăĂắẮằẰẳẲẵẴặẶ]|[âÂấẤầẦẩẨẫẪậẬ]|[éÉèÈẻẺẽẼẹẸ]|[êÊếẾềỀểỂễỄệỆ]|[úÚùÙủỦũŨụỤ]|[ưƯứỨừỪửỬữỮựỰ]|[óÓòÒỏỎõÕọỌ]|[ôÔốỐồỒổỔỗỖộỘ]|[đĐ]/gm);
        this.__regexi = new RegExp(/[^[a-zA-Z0-9áÁảẢãÃạẠăĂắẮằẰẳẲẵẴặẶâÂấẤầẦẩẨẫẪậẬéÉèÈẻẺẽẼẹẸêÊếẾềỀểỂễỄệỆúÚùÙủỦũŨụỤưƯứỨừỪửỬữỮựỰóÓòÒỏỎõÕọỌôÔốỐồỒổỔỗỖộỘđĐ]/gm);
        this.__list = list;
    }
