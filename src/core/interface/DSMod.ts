...
interface DSMod {
	 ...
	 * @memberof DSMod
	 */
	onMsgCreate?: (msg: Message | PartialMessage, arg: string[], bot: SucklessBot) => void;
	 ...
	 * @memberof DSMod
	 */
	onMsgDelete?: (msg: Message | PartialMessage, arg: string[], bot: SucklessBot) => void;
	 ...
	 * @memberof DSMod
	 */
	onMsgUpdate?: (oldMsg: Message | PartialMessage, newMsg: Message | PartialMessage, bot: SucklessBot) => void;
}
